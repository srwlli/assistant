...
### Functional
- [x] nfl-scraper-expert removed from active personas
- [x] research-scout persona created and available
- [x] list_personas shows research-scout
- [x] research-scout follows no-coding constraint

### Quality
- [x] Persona schema valid and complete
- [x] All required fields populated
- [x] Backups preserved (nfl-scraper-expert already in backups/)
